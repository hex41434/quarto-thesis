...
![caption](img/Chp1/mlp.png){#fig-mlp fig-align="center" width="50%"}
...
![caption](img/Chp1/ae.png){#fig-ae fig-align="center" width="50%"}
...
![caption](img/Chp1/cvae.png){#fig-cvae fig-align="center" width="50%"}
...
-   Investigating how implicit representations can replace traditional mesh processing methods in 3D models, and examining the potential benefits of continuous model representations.
-   Developing techniques to balance neural network size, accuracy, and computational efficiency when representing complex and dynamic 3D data.
